<x-template>
    ...
    <div class="mt-12">
        Il progetto prevede l'importazione di più fonti dati. Al momento, anche per motivi di copyright, i dati vengono
        presi esclusivamente da
        <a href="https://it.cathopedia.org/wiki/Cathopedia:Pagina_principale" class="text-violet-950 underline hover:text-amber-600" target="_blank">Cathopedia</a>
